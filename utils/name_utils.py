...
def match_rider_names(riders: Union[pd.DataFrame, List[Dict[str, Any]]], 
                      startlist_riders: List[Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
    """
    ...
    if not isinstance(startlist_riders, list):
        st.warning(f"Expected startlist_riders to be a list, got: {type(startlist_riders)}")
        return {}
...
def _match_by_team_and_name(riders_list: List[Dict[str, Any]], 
                           startlist_riders: List[Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
...
def _match_by_name_only(riders_list: List[Dict[str, Any]], 
                       startlist_riders: List[Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
...
def _try_match_rider_by_name(rider: Dict[str, Any], 
                            startlist_riders: List[Dict[str, Any]], 
                            matched_riders: Dict[str, Dict[str, Any]]) -> None:
